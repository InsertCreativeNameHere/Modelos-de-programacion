 ...
 * @author ldani
 */
public class ConstructorDoomSlayers extends Constructor {
    private FabricaAbstracta miFabrica;

    public ConstructorDoomSlayers() throws UnsupportedAudioFileException, LineUnavailableException {
        this.miFabrica = new FabricaDoomSlayer();
    }
